...
local function getEntityDistanceSquared(index1, index2)
    local entity = AshitaCore:GetMemoryManager():GetEntity();
    local x1 = entity:GetLocalPositionX(index1);
    local y1 = entity:GetLocalPositionX(index1);
    local z1 = entity:GetLocalPositionX(index1);

    local x2 = entity:GetLocalPositionX(index2);
    local y2 = entity:GetLocalPositionX(index2);
    local z2 = entity:GetLocalPositionX(index2);
...
return {
    ...
    getEntityDistanceSquared = getEntityDistanceSquared,
    width = width,
    height = height
};
